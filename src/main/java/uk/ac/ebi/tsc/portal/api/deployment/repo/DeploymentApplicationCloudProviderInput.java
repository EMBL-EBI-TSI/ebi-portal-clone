 ...
 */
@Entity
@Table(name="dep_app_cloud_provider_input")
public class DeploymentApplicationCloudProviderInput {
    ...
    DeploymentApplicationCloudProviderInput() { // jpa only
    }

    public DeploymentApplicationCloudProviderInput(String name, DeploymentApplicationCloudProvider deploymentApplicationCloudProvider) {
        this.name = name;
